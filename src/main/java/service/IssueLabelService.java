...
//
//        String sql = "INSERT INTO issue_labels (label_id, name, created_at) VALUES (?, ?, ?)";
...
//            throw new IllegalArgumentException("Label name is required.");
//
//        String sql = "UPDATE issue_labels SET name=? WHERE label_id=?";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
...
//        String sql = "DELETE FROM issue_labels WHERE label_id=?";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
...
//        String sql = "SELECT * FROM issue_labels ORDER BY name";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
...
//    }
//
//    // ----------- Linking/Unlinking labels to issues ------------
...
//        if (isLabelAssigned(issueId, labelId))  // Check first!
//            throw new IllegalArgumentException("Label already assigned to issue.");
//
//        String sql = "INSERT INTO issue_labels_mapping (issue_id, label_id) VALUES (?, ?)";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
//            ps.setString(1, issueId.toString());
//            ps.setString(2, labelId.toString());
//            ps.executeUpdate();
...
//        String sql = "DELETE FROM issue_labels_mapping WHERE issue_id=? AND label_id=?";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
//            ps.setString(1, issueId.toString());
//            ps.setString(2, labelId.toString());
//            ps.executeUpdate();
...
//        List<IssueLabel> labels = new ArrayList<>();
//        String sql = "SELECT l.* FROM issue_labels l " +
...
//        List<IssueLabel> labels = new ArrayList<>();
//        String sql = "SELECT * FROM issue_labels WHERE LOWER(name) LIKE LOWER(?)";
//        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
