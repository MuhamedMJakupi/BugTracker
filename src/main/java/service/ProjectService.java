...
public class ProjectService extends AbstractService {
    ...
    private final ProjectValidationService validationService = new ProjectValidationService();

    public Project createProject(Project project) throws Exception {

        List<String> errors = validationService.validateProjectForCreation(project);
        if(!errors.isEmpty()) {
    ...
    public void updateProject(Project project) throws Exception {
        ...
        List<String> errors = validationService.validateProjectForUpdate(project);
        if (!errors.isEmpty()) {
            throw new IllegalArgumentException("Validation failed: " + String.join(", ", errors));
        }
