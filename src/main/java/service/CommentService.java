...
public class CommentService extends AbstractService {
    ...
    private final CommentValidationService commentValidationService = new CommentValidationService();
    public Comment createComment(Comment comment) throws Exception {
        List<String> errors = commentValidationService.validateCommentForCreation(comment);
        if (!errors.isEmpty()) {
    ...
    public void updateComment(Comment comment) throws Exception {
        List<String> errors = commentValidationService.validateCommentForUpdate(comment);
        if (!errors.isEmpty()) {
            throw new IllegalArgumentException("Validation failed: " + String.join(", ", errors));
        }
        if(!userExists(comment.getUserId())){
    ...
    public static class SQL {
        ...
        public static final String CREATE_COMMENT ="INSERT INTO comments (comment_id, issue_id, user_id, text, timestamp) VALUES (?,?,?,?,?)";
